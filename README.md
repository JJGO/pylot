...
- 🧪 **Experiment Management** - `experiment` provides a human friendly classes to wrap a lot of the complexity of running experiments. Experiments can be loaded, providing convient access to model, data and logged results.
...
- 📊 **Results Analysis** - Result aggregation primitives such as Pareto frontiers, bootstrapping, recursive selection are included.
